...
| `JAMF_PRO_{DEVELOP\|RC\|GA\|GA_1\|GA_2\|ASYNC_DEPLOYMENT}_{DEV\|STAGE\|PROD}_BASE_URL`         | Jamf Pro base URL               |
| `JAMF_PRO_{DEVELOP\|RC\|GA\|GA_1\|GA_2\|ASYNC_DEPLOYMENT}_{DEV\|STAGE\|PROD}_API_USERNAME`     | Jamf Pro API username           |
| `JAMF_PRO_{DEVELOP\|RC\|GA\|GA_1\|GA_2\|ASYNC_DEPLOYMENT}_{DEV\|STAGE\|PROD}_API_PASSWORD`     | Jamf Pro API password           |
| `JAMF_PRO_{DEVELOP\|RC\|GA\|GA_1\|GA_2\|ASYNC_DEPLOYMENT}_{DEV\|STAGE\|PROD}_ACCOUNT_EMAIL`    | Jamf Account email              |
| `JAMF_PRO_{DEVELOP\|RC\|GA\|GA_1\|GA_2\|ASYNC_DEPLOYMENT}_{DEV\|STAGE\|PROD}_ACCOUNT_PASSWORD` | Jamf Account password           |
